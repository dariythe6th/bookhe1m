        ...
        builder.setPositiveButton("Добавить", (dialog, which) -> {
            try {
                ...
                if (rating < 0 || rating > 5) {
                    Toast.makeText(requireContext(), "Рейтинг должен быть от 0 до 5", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                Toast.makeText(requireContext(), "Проверьте правильность ввода чисел", Toast.LENGTH_SHORT).show();
            }
        });
